    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3" v-for="(formule, formuleIndex) in formules" :key="formuleIndex">
                <div class="card mb-3">
                    <img src="../assets/Boites-a-fleurs.jpg" alt="image formule" class="card-img-top">
                    <div class="card-body">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3" v-for="(the, theIndex) in thes" :key="theIndex">
                <div class="card mb-3">
                    <img src="../assets/the.jpg" alt="the" class="card-img-top img_the_bougie">
                    <div class="card-body">
                        <div class="rows">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3" v-for="(bougie, bougieIndex) in bougies" :key="bougieIndex">
                <div class="card mb-3">
                    <img src="../assets/bougie img.jpg" alt="bougie" class="card-img-top img_the_bougie">
                    <div class="card-body">
