            ...
            <div class="col-12">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="newArticleName" required>
                    </div>
                    <div class="form-group">
                        <label for="prix">Prix</label>
                        <input type="number" step="0.01" class="form-control" id="newArticlePrix" required>
                    </div>
                    <div class="form-group">
                        <label for="type">Type</label>
                        <select class="form-control" id="newArticleType" required>
        ...
        <div v-for="(article, articleIndex) in this.articles" :key="articleIndex" class="card-min">
          ...
          <div class="details-container">
            ...
            <select name="type-article" v-model="selectedTypeIdsArticle[article.id_article]">
              <option value="">{{ article.nom_type_article}}</option>
              <option v-for="(type, typeIndex) in type_articles" :key="typeIndex" :value="type.id">{{ type.nom }}</option>
            </select>
            <hr>
          </div>
...
<script>
import { getAllArticle, updateArticle, addArticle, deleteArticle, getAllTypeArticle} from '@/services/salondethe.services';
